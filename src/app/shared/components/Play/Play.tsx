...
const Play: FC<PlayProps> = (props) => {
  return (
    <section key={props.player.id} className={`grid ${props.isAdmin ? 'grid-cols-3' : 'grid-cols-2'}  content-between pb-8 text-center font-bold hover:text-light ease-in-out duration-200`}>
